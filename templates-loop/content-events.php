...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs" itemprop="breadcrumb">
		<ol class="breadcrumb bg-white" itemscope="" itemtype="https://schema.org/BreadcrumbList">
			...
			<li class="breadcrumb-item breadcrumb-item--post" itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"><a href="/events/" itemprop="item"><span itemprop="name">Events</span></a>
